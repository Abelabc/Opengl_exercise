...
//     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
    ...
    Shader ourShader("./src/06_GLM/shader/vertexshader.glsl", "./src/06_GLM/shader/fragmentshader.glsl");
    ourShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setTrans("transform", 1,trans);
        trans = glm::mat4(1.f);
        ...
        float tmp=abs((sin(30.f*glfwGetTime()) ));
        trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.f));
        trans = glm::scale(trans, glm::vec3(0.5, 0.5, 0.5)*tmp);
        ourShader.setTrans("transform", 1,trans);
        trans = glm::mat4(1.f);
        //float time = glfwGetTime();
